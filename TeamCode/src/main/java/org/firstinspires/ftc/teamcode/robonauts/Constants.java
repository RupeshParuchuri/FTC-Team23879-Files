...
public class Constants {
    ...
    public static final Pose2d R_1_BEGIN_POSE = new Pose2d( new Vector2d(-36, -64), Math.PI/2);
    ...
    public static final Pose2d R_4_BEGIN_POSE = new Pose2d( new Vector2d(12, -64), Math.PI/2);
    ...
    public static final Pose2d B_3_BEGIN_POSE = new Pose2d( new Vector2d(12, 64), -Math.PI/2);
    ...
    public static final Vector2d B_2_STRAFE_RELEASE_PIXEL_RIGHT = new Vector2d(-44, 48);
