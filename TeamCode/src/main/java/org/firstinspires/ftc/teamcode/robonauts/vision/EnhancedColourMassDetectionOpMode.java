...
public class EnhancedColourMassDetectionOpMode extends OpMode {
	...
	public void init() {
		...
		visionPortal = new VisionPortal.Builder()
				.setCamera(hardwareMap.get(WebcamName.class, "c920-webcam")) // the camera on your robot is named "Webcam 1" by default
	...
	public void start() {
		...
		EnhancedColourMassDetectionProcessor.PropPositions recordedPropPosition = colourMassDetectionProcessor.getRecordedPropPosition();
