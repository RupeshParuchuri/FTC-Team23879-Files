...
public class Constants {
    ...
    public static final Vector2d R_1_STRAFE_BACK = new Vector2d(-36, -55);
    ...
    public static final Pose2d R_1_SPLINE_CENTER= new Pose2d( new Vector2d(38, 10), 0);
    ...
    public static final Vector2d R_PARK_BB = new Vector2d(56, -10);
    public static final Vector2d B_PARK_BB = new Vector2d(64, 8);
